<!--
---
title: Introducción a Integración Numérica
type: index
...
La integración numérica consiste en aproximar el valor de integrales definidas $\int_a^b f(x)\,dx$ cuando no es posible obtener una antiderivada en forma cerrada o cuando solo se dispone de valores tabulados de la función.
...
- [[MN-03-T03-Simpson-3-8|Regla de Simpson 3/8]]
...
### Análisis de Error
- [[MN-03-T06-Errores-Cuadratura|Análisis de Errores]]
...
1. Aplicar la regla del trapecio simple y compuesta
...
|----------|--------|-----------|
| [[MN-02-Interpolacion-Intro]] | [[00-Index]] | [[MN-04-EDO-Numericas-Intro]] |
