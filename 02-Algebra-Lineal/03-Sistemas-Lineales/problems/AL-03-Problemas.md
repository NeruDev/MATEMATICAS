...
### [Prob-01] Forma matricial de un sistema 2×2 ⭐
...
### [Prob-02] Eliminación gaussiana básica ⭐
...
### [Prob-03] Sistema 3×3 por eliminación ⭐
...
### [Prob-04] Sistema 3×3 intermedio ⭐⭐
...
### [Prob-05] Sistema 4×4 con verificación ⭐⭐
...
### [Prob-08] Identificación de REF y RREF ⭐⭐

¿Cuál de las siguientes está en REF? ¿En RREF?
...
### [Prob-09] Clasificación de sistema dependiente ⭐
...
### [Prob-10] Clasificación de sistema inconsistente ⭐
...
### [Prob-11] Parámetro para infinitas soluciones ⭐⭐
...
### [Prob-12] Parámetro para sistema sin solución ⭐⭐
...
### [Prob-13] Clasificación paramétrica completa ⭐⭐
...
### [Prob-14] Rango de matriz con filas dependientes ⭐
...
¿Para qué valores de $k$ el rango es menor que 3?
...
### [Prob-18] Sistema homogéneo con infinitas soluciones ⭐
...
Hallar una base para el espacio nulo de $A = \begin{pmatrix} 1 & 2 & 1 \\ 2 & 4 & 3 \end{pmatrix}$.
...
¿Para qué valores de $k$ el sistema homogéneo tiene solución no trivial?
...
Encontrar $a$, $b$, $c$ tal que la parábola $y = ax^2 + bx + c$ pase por $(1, 2)$, $(2, 3)$ y $(3, 6)$.
...
Hallar el polinomio de grado 2 que interpola los puntos $(-1, 4)$, $(0, 1)$, $(2, 7)$.
