...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-01)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-02)

### [Prob-03] Matriz identidad ⭐

Escribir la [matriz identidad](../../../glossary.md#matriz-identidad) $I_4$.

📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-03)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-05)

### [Prob-06] Producto escalar-matriz ⭐

Si $A = \begin{pmatrix} 2 & -1 \\ 3 & 4 \end{pmatrix}$, hallar $2A$.

📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-06)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-07)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-08)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-14)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-15)

### [Prob-16] Matrices idempotentes ⭐⭐⭐

Si $A^2 = A$, demostrar que $(I - A)^2 = I - A$.

📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-16)

### [Prob-17] Matrices que conmutan ⭐⭐⭐

Encontrar todas las matrices $2 \times 2$ que conmutan con $\begin{pmatrix} 1 & 1 \\ 0 & 1 \end{pmatrix}$.

📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-17)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-18)

### [Prob-19] Doble transpuesta ⭐

Verificar que $(A^T)^T = A$ para $A = \begin{pmatrix} 1 & 2 \\ 3 & 4 \\ 5 & 6 \end{pmatrix}$.

📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-19)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-20)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-21)

### [Prob-22] Simetría de A + Aᵀ ⭐⭐

Demostrar que $A + A^T$ es simétrica para cualquier [matriz cuadrada](../../../glossary.md#matriz-cuadrada) $A$.

📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-22)
...
📂 **Solución:** [Ver desarrollo paso a paso](../solutions/prob-23/solucion-metodo.md)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-25)

### [Prob-26] Verificación de inversa ⭐

Verificar que $AA^{-1} = I$ para el resultado del problema anterior.

📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-26)

### [Prob-27] Matriz singular ⭐⭐

Determinar si existe la inversa: $A = \begin{pmatrix} 1 & 2 \\ 2 & 4 \end{pmatrix}$.

📂 **Solución:** [Ver desarrollo paso a paso](../solutions/prob-27/solucion-metodo.md)
...
📂 **Solución:** [Ver desarrollo paso a paso](../solutions/prob-28/solucion-metodo.md)
...
📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-29)

### [Prob-30] Demostración AB = I implica BA = I ⭐⭐⭐

Demostrar que si $AB = I$, entonces $BA = I$ (para matrices cuadradas).

📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-30)

### [Prob-31] Matrices involutivas ⭐⭐⭐

Si $A^2 = I$, demostrar que $A$ es su propia inversa.

📎 **Solución:** [Ver respuesta](../solutions/AL-01-Respuestas.md#prob-31)
