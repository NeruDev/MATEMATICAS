...
### [Prob-01] Integral de potencia básica ⭐
Calcular:
$$\int_0^2 x^2 \, dx$$
...
### [Prob-02] Integral de raíz cuadrada ⭐
Calcular:
$$\int_1^4 \sqrt{x} \, dx$$
...
### [Prob-05] Integral logarítmica natural ⭐
Calcular:
$$\int_1^e \frac{1}{x} \, dx$$
...
### [Prob-08] Integral de función racional ⭐⭐
Calcular:
...
### [Prob-09] Integral de secante cuadrada ⭐⭐
Calcular:
...
## Derivada de Integrales con Límite Variable

### [Prob-11] TFC1 - Límite superior variable ⭐
Hallar:
...
### [Prob-12] TFC1 - Función exponencial ⭐
Hallar:
...
### [Prob-14] TFC1 con regla de la cadena ⭐⭐
Hallar:
...
### [Prob-15] TFC1 con límite inferior variable ⭐⭐
Hallar:
...
### [Prob-16] TFC1 con ambos límites variables ⭐⭐
Hallar:
...
### [Prob-18] TFC1 con límites trigonométricos ⭐⭐⭐
Hallar:
...
### [Prob-19] Sustitución con potencia compuesta ⭐
Calcular:
...
### [Prob-20] Sustitución trigonométrica básica ⭐
Calcular:
...
### [Prob-21] Sustitución exponencial ⭐
Calcular:
$$\int_0^1 xe^{x^2} \, dx$$
...
### [Prob-22] Sustitución con raíz cuadrada ⭐⭐
Calcular:
...
### [Prob-24] Sustitución logarítmica ⭐⭐
Calcular:
...
### [Prob-25] Sustitución con exponencial y fracción ⭐⭐
Calcular:
...
### [Prob-26] Sustitución trigonométrica avanzada ⭐⭐⭐
Calcular:
...
### [Prob-27] Sustitución con raíz cúbica ⭐⭐⭐
Calcular:
...
### [Prob-28] Integral de función impar - potencia ⭐
Calcular:
$$\int_{-2}^{2} x^3 \, dx$$
...
### [Prob-29] Integral de función impar - seno ⭐
Calcular:
$$\int_{-\pi}^{\pi} \sin x \, dx$$
...
### [Prob-30] Integral de función par - potencia ⭐
Calcular:
$$\int_{-1}^{1} x^4 \, dx$$
...
### [Prob-31] Integral de función par - coseno ⭐
Calcular:
$$\int_{-\pi}^{\pi} \cos x \, dx$$
...
### [Prob-32] Integral con suma de par e impar ⭐⭐
Calcular:
$$\int_{-2}^{2} (x^3 + x^2) \, dx$$
...
### [Prob-33] Integral con seno y coseno ⭐⭐
Calcular:
...
### [Prob-34] Integral de función par racional ⭐⭐
Calcular:
...
Encontrar el valor promedio de $f(x) = x^2$ en $[0, 3]$.

> **Solución:** Ver [solutions/prob-39/](../solutions/prob-39/)

---

### [Prob-40] Integral con valor absoluto ⭐⭐⭐
Calcular:
...
### [Prob-42] Demostración de igualdad de integrales ⭐⭐⭐
Demostrar que:
