...
**Condición de existencia:** $f(t)$ de orden exponencial y seccionalmente continua.
...
2. Usar propiedades de derivadas con condiciones iniciales
3. Despejar $Y(s)$
...
<!--
IA: Hoja de referencia rápida para Transformada de Laplace.
