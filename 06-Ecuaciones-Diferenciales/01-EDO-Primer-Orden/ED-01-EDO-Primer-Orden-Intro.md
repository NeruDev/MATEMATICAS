...
1. **Conceptos fundamentales**: orden, grado, [solución general](../../glossary.md#solución-general) y particular
...
6. **Ecuaciones homogéneas**: [sustitución](../../glossary.md#sustitución) $y = vx$

## Conexiones

- **Prerequisitos**: [Cálculo Integral](../../glossary.md#cálculo-integral) (integración, técnicas)
