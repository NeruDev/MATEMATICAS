...
| $\equiv$ | Idénticamente igual | `\equiv` | Igualdad en todo el [dominio](../../../glossary.md#menor) que | `<` | Comparación estricta |
...
| Símbolo | Nombre | LaTeX | Uso / Significado |
| :---: | :--- | :--- | :--- |
| $\lim$ | [Límite](../../../glossary.md#funcion) |
| $\lim_{x \to a}$ | [Límite](../../../glossary.md#derivada) (prima) | `f'(x)` | Primera derivada de $f$ |
| $f''(x)$ | Segunda [derivada](../../../glossary.md#orden) $n$ |
| $\frac{dy}{dx}$ | Derivada (Leibniz) | `\frac{dy}{dx}` | Tasa de cambio instantánea |
| $\frac{d^n y}{dx^n}$ | Derivada n-ésima | `\frac{d^n y}{dx^n}` | Derivada de [orden](../../../glossary.md#integral-indefinida) | `\int` | [Antiderivada](../../../glossary.md#integral-definida) | `\int_a^b` | Área bajo la curva de $a$ a $b$ |
...
| $du$ | Cambio de variable | `du` | [Sustitución](../../../glossary.md#constante-de-integracion) | `+ C` | Familia de antiderivadas |
...
| $\nabla f$ | Gradiente | `\nabla f` | [Vector](../../../glossary.md#divergencia) | `\nabla \cdot \vec{F}` | Flujo escalar de un campo |
| $\nabla \times \vec{F}$ | Rotacional | `\nabla \times \vec{F}` | Tendencia a rotar (circulación) |
| $\nabla^2$ | Laplaciano | `\nabla^2` | [Divergencia](../../../glossary.md#transpuesta) | `A^T` o `A^\top` | Filas por columnas |
| $A^{-1}$ | Inversa | `A^{-1}` | [Matriz](../../../glossary.md#tal-que) $AA^{-1}=I$ |
| $A^\dagger$ | Hermitiana (adjunta) | `A^\dagger` | [Transpuesta](../../../glossary.md#determinante) | `\det(A)` | [Factor de escala](../../../glossary.md#traza) | `\text{tr}(A)` | Suma de elementos diagonales |
| $\text{rank}(A)$ | Rango | `\text{rank}(A)` | [Dimensión](../../../glossary.md#matriz-identidad) | `I` | Diagonal de unos |
| $O$ | [Matriz](../../../glossary.md#vector) (flecha) | `\vec{v}` | Notación física de vector |
| $\mathbf{v}$ | Vector (negrita) | `\mathbf{v}` | Notación algebraica de vector |
| $\hat{v}$ | Vector unitario | `\hat{v}` | Vector de magnitud 1 |
| $\hat{i}, \hat{j}, \hat{k}$ | [Base](../../../glossary.md#generalizacion) del producto punto |
...
| $\dim(V)$ | [Dimensión](../../../glossary.md#base) |
...
| Símbolo | Nombre | LaTeX | Uso / Significado |
| :---: | :--- | :--- | :--- |
| $\sin \theta$ | [Seno](../../../glossary.md#coseno) | `\cos` | Razón adyacente/hipotenusa |
| $\tan \theta$ | [Tangente](../../../glossary.md#seno)/[coseno](../../../glossary.md#tangente) |
...
| $\mathcal{L}\{f\}$ | [Transformada de Laplace](../../../glossary.md#dominio) de frecuencia |
