...
**Desarrollo:**
Como los puntos están en orden $A$, $B$, $C$, $D$:
$$AD = AB + BC + CD$$
$$12 = 3 + 5 + CD$$
$$CD = 12 - 8 = 4 \text{ cm}$$
...
### Solución 4.3.2
**Contexto:** En un triángulo isósceles, los ángulos de la base (opuestos a los lados iguales) son iguales.
...
### Solución 4.6.8
**Contexto:** La tangente desde un punto exterior es perpendicular al radio en el punto de tangencia, formando un triángulo rectángulo.
