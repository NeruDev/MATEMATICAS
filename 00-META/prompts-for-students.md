...
```
Convierte `[theory/CD-01-Teoria-Limites.md](theory/CD-01-Teoria-Limites.md)` a lenguaje natural apto para explicar a alguien sin matemáticas en 6 frases.
```
...
```
Basándote en los problemas de `[problems/AL-02-Problemas.md](problems/AL-02-Problemas.md)`, identifica los 5 tipos de ejercicios más importantes para un examen y dame un ejemplo de cada uno.
```
