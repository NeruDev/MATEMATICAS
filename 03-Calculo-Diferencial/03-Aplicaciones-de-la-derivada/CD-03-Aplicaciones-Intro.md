...
- Si $f'(c) = 0$ y $f''(c) < 0$ → **Máximo local**
- Si $f'(c) = 0$ y $f''(c) > 0$ → **Mínimo local**
- Si $f'(c) = 0$ y $f''(c) = 0$ → **Inconcluso**
...
> **Nota**: Los problemas de optimización son muy comunes en exámenes y aplicaciones reales. Practica el proceso sistemático de plantear y resolver estos problemas.
