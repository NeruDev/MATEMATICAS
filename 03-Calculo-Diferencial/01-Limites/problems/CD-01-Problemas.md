...
📂 **Solución:** [Ver desarrollo paso a paso](../solutions/prob-05/solucion-metodo.md)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-09)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-10)

### [Prob-11] Límite de composición con raíz ⭐
Evalúa $\lim_{x \to 2} \sqrt{x^2 + 5}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-11)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-12)

### [Prob-13] Teorema del emparedado ⭐⭐⭐
Usa el teorema del emparedado para evaluar $\lim_{x \to 0} x^2 \cos\left(\frac{1}{x}\right)$.

📂 **Solución:** [Ver desarrollo paso a paso](../solutions/prob-13/solucion-metodo.md)
...
📂 **Solución:** [Ver desarrollo paso a paso](../solutions/prob-14/solucion-metodo.md)

### [Prob-15] Factorización de trinomio cuadrado ⭐
$\lim_{x \to -2} \frac{x^2 + 5x + 6}{x + 2}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-15)

### [Prob-16] Factorización doble ⭐
$\lim_{x \to 3} \frac{x^2 - 9}{x^2 - 5x + 6}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-16)

### [Prob-17] Factorización de diferencia de cubos ⭐⭐
$\lim_{x \to 1} \frac{x^3 - 1}{x - 1}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-17)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-19)

### [Prob-20] Racionalización de denominador ⭐⭐
$\lim_{x \to 9} \frac{3 - \sqrt{x}}{9 - x}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-20)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-22)

### [Prob-23] Límite con raíz cúbica ⭐⭐⭐
$\lim_{x \to 1} \frac{x^{1/3} - 1}{x - 1}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-23)
...
📂 **Solución:** [Ver desarrollo paso a paso](../solutions/prob-24/solucion-metodo.md)

### [Prob-25] Límite seno con coeficiente ⭐
$\lim_{x \to 0} \frac{\sin x}{3x}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-25)

### [Prob-26] Cociente de senos ⭐⭐
$\lim_{x \to 0} \frac{\sin 3x}{\sin 5x}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-26)

### [Prob-27] Límite de tangente ⭐⭐
$\lim_{x \to 0} \frac{\tan x}{x}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-27)

### [Prob-28] Límite 1-cos x ⭐⭐
$\lim_{x \to 0} \frac{1 - \cos x}{x^2}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-28)

### [Prob-29] Cuadrado de seno ⭐⭐
$\lim_{x \to 0} \frac{\sin^2 x}{x^2}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-29)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-31)

### [Prob-32] Límite trigonométrico compuesto ⭐⭐⭐
$\lim_{\theta \to 0} \frac{\sin 3\theta}{\theta \cos 2\theta}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-32)

### [Prob-33] Límite en π/4 ⭐⭐⭐⭐
$\lim_{x \to \pi/4} \frac{\sin x - \cos x}{1 - \tan x}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-33)
...
📂 **Solución:** [Ver desarrollo paso a paso](../solutions/prob-34/solucion-metodo.md)

### [Prob-35] Cociente de polinomios cuadráticos ⭐
$\lim_{x \to \infty} \frac{x^2 + 1}{2x^2 - 3}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-35)

### [Prob-36] Grado mayor en denominador ⭐
$\lim_{x \to \infty} \frac{5x}{x^2 + 4}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-36)

### [Prob-37] Grado mayor en numerador ⭐⭐
$\lim_{x \to \infty} \frac{x^3 - 2x}{3x^2 + x}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-37)

### [Prob-38] Límite a menos infinito ⭐⭐
$\lim_{x \to -\infty} \frac{2x^2 - x}{x^2 + 1}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-38)

### [Prob-39] Forma infinito - infinito ⭐⭐
$\lim_{x \to \infty} \left(\sqrt{x^2 + x} - x\right)$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-39)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-41)

### [Prob-42] Función acotada al infinito ⭐⭐⭐
$\lim_{x \to \infty} \frac{\sin x}{x}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-42)

### [Prob-43] Número e ⭐⭐⭐⭐
$\lim_{x \to \infty} \left(1 + \frac{1}{x}\right)^x$

📂 **Solución:** [Ver desarrollo paso a paso](../solutions/prob-43/solucion-metodo.md)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-44)

### [Prob-45] Límite infinito con exponente par ⭐
$\lim_{x \to 2^-} \frac{1}{(x-2)^2}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-45)

### [Prob-46] Límite infinito bilateral ⭐⭐
$\lim_{x \to 0} \frac{1}{x^2}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-46)

### [Prob-47] Cociente con factor cuadrático ⭐⭐
$\lim_{x \to 1} \frac{x^2}{(x-1)^2}$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-47)

### [Prob-48] Asíntotas verticales ⭐⭐
Encuentra las asíntotas verticales de $f(x) = \frac{x}{x^2-4}$.

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-48)

### [Prob-49] Análisis completo de asíntotas ⭐⭐⭐
Encuentra todas las asíntotas de $f(x) = \frac{x^2 - 1}{x^2 - 4}$.

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-49)

### [Prob-50] Forma 0·∞ ⭐⭐⭐
$\lim_{x \to 0^+} x \ln x$

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-50)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-51)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-52)

### [Prob-53] Puntos de discontinuidad ⭐⭐
Determina los puntos de discontinuidad de $f(x) = \frac{1}{x^2 - 5x + 6}$.

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-53)

### [Prob-54] Extensión continua con seno ⭐⭐
¿Es continua $f(x) = \begin{cases} \frac{\sin x}{x} & x \neq 0 \\ 1 & x = 0 \end{cases}$?

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-54)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-55)

### [Prob-56] Clasificación de discontinuidades ⭐⭐⭐
Clasifica todas las discontinuidades de $f(x) = \frac{\lvert x-2 \rvert}{x-2}$.

📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-56)
...
📎 **Solución:** [Ver respuesta](../solutions/CD-01-Respuestas.md#prob-57)
