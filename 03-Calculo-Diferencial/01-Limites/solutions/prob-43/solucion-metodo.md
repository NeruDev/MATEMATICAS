...
Este límite define el **número de Euler** $e$:
...
Cada término es menor que $\frac{1}{k!}$, entonces:
$$\left(1 + \frac{1}{n}\right)^n < 1 + 1 + \frac{1}{2!} + \frac{1}{3!} + \cdots = e < 3$$

### Paso 4: Conclusión
Por el teorema de convergencia monótona, la sucesión convergente a un número que llamamos $e$.
...
## Aplicaciones
- Base del logaritmo natural: $\ln x = \log_e x$
