...
## Nota importante
El límite existe a pesar de que $\cos\left(\frac{1}{x}\right)$ no tiene límite cuando $x \to 0$. El factor $x^2$ "aplasta" las oscilaciones hacia cero.

Este es un ejemplo clásico donde la sustitución directa no funciona pero el teorema del emparedado sí.
