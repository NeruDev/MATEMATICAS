...
**Conclusión:** Existe al menos un $c \in (a, b)$ [tal que](../../glossary.md#tangente) en $c$ es igual a la pendiente de la recta secante que une $(a, f(a))$ y $(b, f(b))$.
...
2. **Cálculo de [límites](../../glossary.md#base) de muchos algoritmos
